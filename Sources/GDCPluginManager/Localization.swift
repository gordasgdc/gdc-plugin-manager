...
enum L {
    ...
    private static let table: [String: [AppLanguage: String]] = [
        ...
        "tutorials.showTags": [.ro: "Taguri (%d)", .en: "Tags (%d)", .es: "Etiquetas (%d)"],
        ...
        "card.showDescription": [.ro: "Descriere", .en: "Description", .es: "Descripción"],
        ...
        "card.failed": [.ro: "Eroare", .en: "Error", .es: "Error"],
        "state.empty.title": [.ro: "Nimic aici încă", .en: "Nothing here yet", .es: "Nada por aquí"],
        "state.error.title": [.ro: "Catalogul nu a putut fi citit", .en: "The catalog couldn't be read", .es: "No se pudo leer el catálogo"],
        "state.resetFilters": [.ro: "Resetează filtrele", .en: "Reset filters", .es: "Restablecer filtros"],
        "offline.banner.title": [.ro: "Fără conexiune", .en: "No connection", .es: "Sin conexión"],
        "offline.banner.body": [.ro: "Afișăm catalogul salvat local. Instalările noi pot eșua până revine conexiunea.", .en: "Showing the locally saved catalog. New installs may fail until the connection is back.", .es: "Mostramos el catálogo guardado localmente. Las nuevas instalaciones pueden fallar hasta que vuelva la conexión."],
        "update.check.failed.title": [.ro: "Verificarea actualizărilor a eșuat", .en: "Update check failed", .es: "Falló la comprobación de actualizaciones"],
        "card.retry": [.ro: "Reîncearcă", .en: "Retry", .es: "Reintentar"],
        "card.incompatible": [.ro: "Incompatibil", .en: "Incompatible", .es: "Incompatible"],
        "card.offline": [.ro: "Offline", .en: "Offline", .es: "Sin conexión"],
        "card.offline.note": [.ro: "Fără conexiune — catalogul afișat e cel salvat local.", .en: "No connection — showing the locally saved catalog.", .es: "Sin conexión: se muestra el catálogo guardado localmente."],
        ...
        "pdfKind.audioInstructions": [.ro: "Instrucțiuni Audio", .en: "Audio Instructions", .es: "Instrucciones de Audio"],
        "pdfKind.technicalGuide": [.ro: "Ghid Tehnic", .en: "Technical Guide", .es: "Guía Técnica"],
        "pdfKind.book": [.ro: "Carte", .en: "Book", .es: "Libro"],
        "pdfKind.manual": [.ro: "Manual", .en: "Manual", .es: "Manual"],
        ...
        "sidebar.section.developer": [.ro: "DEVELOPER", .en: "DEVELOPER", .es: "DESARROLLADOR"],
        "sidebar.developer.apps": [.ro: "Aplicații & Utilitare", .en: "Apps & Utilities", .es: "Aplicaciones y utilidades"],
        "sidebar.developer.scripts": [.ro: "Scripturi & Automation", .en: "Scripts & Automation", .es: "Scripts y automatización"],
        "sidebar.developer.sdk": [.ro: "SDK & Resurse Dev", .en: "SDK & Dev Resources", .es: "SDK y recursos dev"],
        ...
        "courses.access.free": [.ro: "Gratuit", .en: "Free", .es: "Gratis"],
        "courses.access.oneTime": [.ro: "Plată Unică", .en: "One-time Purchase", .es: "Pago Único"],
        "courses.access.subscription": [.ro: "Abonament", .en: "Subscription", .es: "Suscripción"],
        "courses.access.liveMentoring": [.ro: "Live / Mentorat 1-la-1", .en: "Live / 1-on-1 Mentoring", .es: "En Vivo / Mentoría 1-a-1"],
        "courses.access.link": [.ro: "Acces / Școală Online", .en: "Access / Online School", .es: "Acceso / Escuela Online"],
        "courses.validity.lifetime": [.ro: "Acces pe viață", .en: "Lifetime access", .es: "Acceso de por vida"],
        "courses.validity.days": [.ro: "Acces %d zile de la înscriere", .en: "%d-day access from registration", .es: "Acceso %d días desde el registro"],
